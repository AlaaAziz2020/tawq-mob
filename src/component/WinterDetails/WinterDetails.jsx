...
import "../WinterDetails/WinterDetails.css";
...
export default function WinterDetails() {
  ...
  return (
    <div className="product-page mb-5 pb-5  container c">

      {/* العنوان */}
      <h1 className="product-heading product-heading2" >
...
<div className="action mt-3  d-flex justify-content-center">
    <div className="installement ">
        ...
        <h4 className=" text-white" style={{    fontSize:"20px"}}>شحن دولي وداخلي</h4>
    </div>
