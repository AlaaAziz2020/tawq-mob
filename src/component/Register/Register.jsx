...
/>
          ...
          <div className="form col-12 col-md-6 text-end">
            ...
            />
            {errors.username && <small className="validate text-danger">{errors.username}</small>}
            ...
            />
            {errors.email && <small className="validate text-danger">{errors.email}</small>}
            ...
            {errors.country && <small className="validate text-danger">{errors.country}</small>}

            <label className="mt-2">رقم الجوال</label>
            <div className="d-flex gap-2">
              <select
                className="form-control"
               style={{ width: "18%", height:"58px"}}
                value={code}
            ...
            {errors.phone && <small className="validate text-danger">{errors.phone}</small>}
            ...
            {errors.password && <small className="validate text-danger">{errors.password}</small>}

            {apiError && <p className="validate text-danger">{apiError}</p>}
