...
import "../SellerFinancialSupport/SellerFinancialSupport.css";
import eyedark from '../../assets/eyedark.png';
import whitesupport from '../../assets/whitesupport.png';

export default function SellerFinancialSupport() {
        ...
        <div className="row">
          ...
          <div className="col-lg-3  d-lg-block support-tabs-column">
            <div className="support-tabs tabs2">
              ...
              {/* الدعم العيني */}
              <Link to="/seller/selleresupport" className="text-decoration-none support-tab inactive-tab">
                <img src={eyedark} />
