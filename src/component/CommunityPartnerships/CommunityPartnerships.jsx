...
export default function CommunityPartnerships() {
    ...
    <div className="community-page mt-2 pb-5 mb-5">
      <Container fluid>
        <div className="community-card shadow-sm   mb-5">
          ...
          {/* ===== الفورم ===== */}
          <Form className="community-form  pb-3">
            <Row className="g-4">
              {/* العمود اليمين */}
              <Col xs={12} md={6}>
                <Form.Label className="mb-2 pt-4">اسم الجهة المشاركة</Form.Label>
                <Form.Control
                  className="inputs mb-4"
                  placeholder="جهة مجتمعية"
                />

                <Form.Label className=" mb-2 ">نوع الجهة</Form.Label>
                <Form.Control
                  className="inputs mb-4"
                  placeholder="جهة مجتمعية"
                />
                ...
                <Form.Control className="inputs mb-4" placeholder="00" />

                <Form.Label className=" mb-2 pb-1">الحساب البنكي</Form.Label>
                <Form.Control
                  className="inputs mb-3"
                  placeholder="745127845123"
                />

                <Form.Label className=" mb-2 pt-2">رقم الهاتف</Form.Label>
                <Row className="g-2 align-items-stretch mb-4">
                  <Col xs={4}>
              ...
              {/* العمود الشمال */}
              <Col xs={12} md={6}>
                <Form.Label className="mb-2 pt-4">الدولة</Form.Label>
                <Form.Control
                  className="inputs mb-4"
                  placeholder="السعودية"
                />

                <Form.Label className=" mb-2">المدينة</Form.Label>
  ...
  <label className="radio-item">
    ...
    <input type="radio" name="period" />
                ...
                <Form.Label className=" mt-2 pb-1">
                   مدة التعاقد
                </Form.Label>
                     {/* <Form.Control
                  className="inputs "
  ...
  <input
    type="number"
    min="1"
    className="inputs duration-input"
    placeholder=" "
  />
  <span className="duration-unit">شهر</span>
</div>
              {/* <br/> */}
                <Form.Label className="mb-0  pb-2 " style={{paddingTop:"10px"}}>
                ...
                <Form.Label className="pt-2 mb-2">
