...
export default function OffersTawq() {
  ...
  return (
    <div className="offers-wrapper2 mb-5 pb-5 " style={{marginTop: "140px"}} >
      <div className=" container ">
      <h1 className="first-heading mt-5 pb-5">عروض طوق نجاة</h1>
        <div className="row">
        ...
        {sections.map((sec, index) => (
          <section key={index} className="">
            ...
            <div className="offerscustomer-products-header2 " >
