...
import "../SellerFooter/SellerFooter.css";
        ...
        <div className="row footer-content">
          ...
          <div className="col-6 col-md-3 footer-col">
            ...
            <ul className="company-list">
              <Link to="/seller/sellerabouttawq" className="text-decoration-none">
               <li className="text-white text-decoration-none">من نحن</li>
              </Link>
                      <Link to="/seller/sellerprivacy" className="text-decoration-none">
               <li className="text-white ">سياسة الخصوصية</li>
              </Link>
                      <Link to="/seller/sellerterms" className="text-decoration-none">
